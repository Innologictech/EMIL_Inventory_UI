...
// Register action
export const Register = createAction('[Authentication] Register', props<{ employeeCode: string, username: string, password: string }>());
...
// login action
export const login = createAction('[Authentication] Login', props<{ employeeCode: string, password: string }>());
