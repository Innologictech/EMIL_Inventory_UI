...
//         });
//       } else if (res.message == 'Invalid Credentials') {   // ✅ compare as number
//         console.log('400 Status Detected');
//         Swal.fire('Invalid Credentials', 'Please try again.', 'error');
//       }else {
//         Swal.fire('Login failed', 'Something went wrong. Please try again later.', 'error');
//       }
//     },
//     error: (err) => {
//       this.spinner.hide();
